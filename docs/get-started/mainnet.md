...
| ---- | --------- | -------- | ----| ----- |
| 9082592 | goleveldb (default） | [v1.7](https://github.com/oracleNetworkProtocol/plugchain/releases/tag/v1.7.0) | [mainnet-9082592-20230411-goleveldb.zip](https://snapshot-node-mainnet.oss-cn-hangzhou.aliyuncs.com/mainnet-9082592-20230411-goleveldb.zip) | （135.289GB）crop data |
