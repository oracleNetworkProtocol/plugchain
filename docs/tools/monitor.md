...
# Plug Chain Hub Monitor

## Introduction

Plug Chain Hub can report and serve the Prometheus metrics, which can be consumed by Prometheus collector(s).
...
Application metrics, namespace: `plugchaind`
...
Plug Chain Hub metrics also contains tendermint metrics, Visit [tendermint metrics](https://github.com/Plug Chain/tendermint/blob/Plug Chain/master/docs/tendermint-core/metrics.md) for more information.

## Start Monitor

This is an example for getting started with the Plug Chain Hub Monitor by using docker.
