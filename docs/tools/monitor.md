...
# PLUGChain Hub Monitor

## Introduction

PLUGChain Hub can report and serve the Prometheus metrics, which can be consumed by Prometheus collector(s).
...
PLUGChain Hub metrics also contains tendermint metrics, Visit [tendermint metrics](https://github.com/PLUGChain/tendermint/blob/PLUGChain/master/docs/tendermint-core/metrics.md) for more information.

## Start Monitor

This is an example for getting started with the PLUGChain Hub Monitor by using docker.
