...
# Get transactions through hash

- Obtain transaction details through hash value

### Request method
`GET`

### URL
`/server/v1/tx/tx_by_hash`

### Request example

```
/server/v1/tx/tx_by_hash?hash=E77C68D8381A23933FF581BA13B1643D4E286FCF4B4A27772A24CC30D4E7C608
```
