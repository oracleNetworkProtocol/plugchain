...
func (app *App) BlockAddrs() map[string]bool {
	blockedAddrs := make(map[string]bool)
	for acc := range maccPerms {
		blockedAddrs[string(authtypes.NewModuleAddress(acc).String())] = !allowedReceivingModAcc[acc]
	}
	return blockedAddrs
}
