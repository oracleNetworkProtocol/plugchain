...
func (m *CollectionIDs) Reset()         { *m = CollectionIDs{} }
func (m *CollectionIDs) String() string { return proto.CompactTextString(m) }
func (*CollectionIDs) ProtoMessage()    {}
func (*CollectionIDs) Descriptor() ([]byte, []int) {
	return fileDescriptor_fe8ab7e15b7f0646, []int{3}
}
func (m *CollectionIDs) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *CollectionIDs) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_CollectionIDs.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *CollectionIDs) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CollectionIDs.Merge(m, src)
}
func (m *CollectionIDs) XXX_Size() int {
	return m.Size()
}
func (m *CollectionIDs) XXX_DiscardUnknown() {
	xxx_messageInfo_CollectionIDs.DiscardUnknown(m)
}

var xxx_messageInfo_CollectionIDs proto.InternalMessageInfo

type Owner struct {
	Address       string          `protobuf:"bytes,1,opt,name=address,proto3" json:"address,omitempty"`
	CollectionIDs []CollectionIDs `protobuf:"bytes,2,rep,name=collection_ids,json=collectionIds,proto3" json:"collection_ids" yaml:"cids"`
}
...
func init() {
	...
	proto.RegisterType((*CollectionIDs)(nil), "plugchain.nft.CollectionIDs")
...
var fileDescriptor_fe8ab7e15b7f0646 = []byte{
	...
	,
}
...
func (this *CollectionIDs) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*CollectionIDs)
	if !ok {
		that2, ok := that.(CollectionIDs)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (m *CollectionIDs) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *CollectionIDs) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *CollectionIDs) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *CollectionIDs) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *CollectionIDs) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: CollectionIDs: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CollectionIDs: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *Owner) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.CollectionIDs = append(m.CollectionIDs, CollectionIDs{})
