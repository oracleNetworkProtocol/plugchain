...
var (
	pattern_Query_Denom_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"x", "nft", "denoms", "denom_id"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Denoms_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"x", "nft", "denoms"}, "", runtime.AssumeColonVerbOpt(false)))
)
