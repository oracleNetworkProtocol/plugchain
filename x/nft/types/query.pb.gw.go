...
var (
	filter_Query_Owner_0 = &utilities.DoubleArray{Encoding: map[string]int{"address": 0, "denom_id": 1}, Base: []int{1, 1, 2, 0, 0}, Check: []int{0, 1, 1, 2, 3}}
)
...
var (
	pattern_Query_Denom_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2}, []string{"nft", "denoms", "denom_id"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Denoms_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"nft", "denoms"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_NFT_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 1, 0, 4, 1, 5, 3}, []string{"nft", "nfts", "denom_id", "nft_id"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Collection_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2}, []string{"nft", "collections", "denom_id"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Supply_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 2, 3}, []string{"nft", "collections", "denom_id", "supply"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Owner_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 1, 0, 4, 1, 5, 3}, []string{"nft", "nfts", "address", "denom_id"}, "", runtime.AssumeColonVerbOpt(false)))
)
