...
import (
	...
	"github.com/oracleNetworkProtocol/plugchain/x/plugchain/client/cli"
	"github.com/oracleNetworkProtocol/plugchain/x/plugchain/keeper"
...
func (am AppModule) RegisterServices(cfg module.Configurator) {
	//register msg-server and grpc-query-server
