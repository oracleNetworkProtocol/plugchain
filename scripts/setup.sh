...
plugchaind keys add $KEY --keyring-backend $KEYRING --algo $KEYALGO
...
plugchaind start --pruning=nothing $TRACE --log_level $LOGLEVEL --minimum-gas-prices=0.0001uplugcn --json-rpc.api eth,txpool,personal,net,debug,web3
