...
func sendTx() error {
    ...
    msg1 := stakingtypes.NewMsgCreateValidator(...)
...
func sendTx() error {
    ...
    msg1 := stakingtypes.NewMsgDelegate()(...)
...
func sendTx() error {
    ...
    msg1 := stakingtypes.NewMsgUndelegate(...)
...
func sendTx() error {
    ...
    var pubkey string //执行操作的地址的公钥
    var accountSeq uint64 //执行操作地址的sequence
